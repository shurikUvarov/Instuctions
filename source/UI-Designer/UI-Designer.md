...
Над каждым элементом написано состояние, изображение которого на данный момент отображается. Чтобы изменить состояние элемента и соотвественно его изображение, нажмите по нему. Если у элемента нет изображения для других состояний, то ничего не произойдет.
...
Использование горячих клавиш в UI-Designer помогает работать быстрее, облегчая навигацию, редактирование и управление потоками. Ниже приведен список горячих клавиш UI-Designer:
...
| Shift + "+" | Увеличить размер выдленного элемента |
...
| → | Переместить выделенные элемент вправо на единицу|
...
Приблизить рабочее пространство можно также зажав `Alt` и используя колесико мыши

Перемещаться по рабочему пространству можно зажав `Space` и кнопку мыши, перемещая курсор